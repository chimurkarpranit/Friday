...
<head runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <td>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" Width="450px">
            <Columns>
